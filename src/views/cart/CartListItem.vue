<template>
  <div id="shop-item">
    <div class="item-selector">
      <check-button :is-checked="itemInfo.checked" @click.native="checkedClick"></check-button>
    </div>
    <div class="item-img">
    ...
    <div class="item-info">
      ...
      <div class="info-bottom">
        ...
        <div class="item-deleft" @click="delectCilck">
          <img src="~assets/image/cart/delect.png" alt="" class="delectimg">
        </div>
        <div class="item-count right">
          <div @click="constAdd">
            <img src="~assets/image/cart/add.png" alt="" class="delectimg">
          </div>
          {{itemInfo.count}}
          <div @click="constMinus">
            <img src="~assets/image/cart/minus.png" alt="" class="delectimg">
          </div>
        </div>
      </div>
    </div>
